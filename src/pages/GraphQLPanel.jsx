                        ...
                        >
                            {history.map((h, index) => (
                                <div
                                    ...
                                    className={`flex items-center justify-between px-5 space-x-4 w-48 h-full  text-center cursor-pointer ${activeTab === index + 1
                    ...
                    <div className="flex space-x-7">
                        {tabs.map((t) => (
                            <button
                                ...
                                className={`lg:text-[13px] text-[12px] font-bold hover:text-white ${tap === t.name
                    ...
                    {tap === "Query" && (
                         ...
                         <div>
                             <div className="sticky z-10 flex items-center justify-between border-y border-zinc-800/80 bg-primary pl-4">
                                 {/* <!-- Label --> */}
                                 <label className="lg:text-xs text-[10px] text-zinc-500 font-bold px-4">Query</label>
                                 ...
                                 <div className="flex">
                                     ...
                                     >
                                         <span className="inline-flex items-center justify-center whitespace-nowrap ">
                                             <svg viewBox="0 0 24 24" width="1em" height="1em" className="svg-icons mr-2">
                                                 <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m6 3l14 9l-14 9z"></path>
                                             </svg>
                                             <div className="truncate text-[13px] text-[13px]">Request</div>
                                         </span>
                                     </button>
                                     ...
                                     >
                                         <span className="inline-flex items-center justify-center whitespace-nowrap ">
                                             <svg viewBox="0 0 24 24" width="1em" height="1em" className="svg-icons">
                                                 <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                     ...
                                     {/* <!-- Button Icons --> */}
                                     <button aria-label="button" role="button" className="icon-btn p-2 text-zinc-400 hover:text-white" tabindex="0">
                                         <svg viewBox="0 0 24 24" width="1em" height="1em" className="svg-icons">
                                             <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
    ...
    value
                    ...
                    {tap === "Variables" && (
                        <>
                            <div className="sticky z-10 flex items-center justify-between border-y border-zinc-800/80 bg-primary pl-4">
                                {/* <!-- Label --> */}
                                <label className="lg:text-xs text-[10px] text-zinc-500 font-bold px-4">Variables</label>
